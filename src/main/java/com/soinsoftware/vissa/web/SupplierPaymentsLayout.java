...
public class SupplierPaymentsLayout extends AbstractEditableLayout<Collection> {
	...
	protected static final Logger log = Logger.getLogger(SupplierPaymentsLayout.class);
	...
	public SupplierPaymentsLayout() throws IOException {
		super("Cuentas por cobrar", KEY_COLLECTION);
